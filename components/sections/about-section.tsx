      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-8">
          <p className="text-paragraph">
            {`Hello, I am Aeyla Naseer, a front-end developer.I am currently studying Cloud-Applied-Generative-Ai from GIAIC. I am specialize in creating visually appealing and user-friendly interfaces using HTML, CSS, and TypeScript. With expertise in React and Next.js framework, I build dynamic and responsive web applications.`}
          </p>
          <p className="text-paragraph">
            {` I developed a keen eye for design and a passion for delivering seamless user experiences. I prioritize clean and maintainable code to ensure scalability and code quality.`}
          </p>
          <p className="text-paragraph">
